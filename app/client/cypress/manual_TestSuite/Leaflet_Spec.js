const dsl = require("../../../fixtures/LeafletWidgetDsl.json");

describe("Leaflet Functionality ", function() {
  it("1. When added to a page it shows City of London", function() {
    // Add a Leaflet widget to a page
    // It opens on City of London with:
    //  - a blue marker
    //  - a green circle
    //  - a green polygon
    //  - a copyright notice at the right bottom
  });
